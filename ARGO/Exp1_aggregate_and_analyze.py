...
def load_all_results(data_dir='draw_figs/data', pattern='exp1_real_cost_impact_custom_*.json'):
    """加载所有实验结果文件"""
...
def main():
    ...
    parser.add_argument('--data-dir', type=str, default='draw_figs/data',
                       help='数据目录')
    parser.add_argument('--pattern', type=str, default='exp1_real_cost_impact_custom_*.json',
                       help='文件匹配模式')
